# Story Output Template, Effort Sizing & Save Location (Health Cloud)

The exact output format every generated Health Cloud story must follow, plus effort sizing
...
1. Header (Persona, Priority, Sub-domain, OmniScript, IPs, Relevant Requirements, Legacy Source) — **required**
...
5. Current State (from codebase / Legacy) — _optional_
...
**Legacy Source:** [Original legacy system object/feature this migrates from — omit if net-new]
...
## Current State (from codebase / Legacy)

### [Component or Legacy feature]

- **[Element]** ([Type]): [Current behavior — from actual codebase files, or the legacy Legacy behavior being replaced]
- **Location:** `[file path or Legacy object name]`
...
| **XXL** | 3+ days | 8+ | Multi-component integration | Cross-flow redesign, new object model, Legacy→HC data migration, multi-system integration (Data Cloud, ERP) |
...
- **Story file:** `requirements/<PascalCaseTitle>.md` (e.g.
  `requirements/HC_PatientCallLogging_UserStory.md`). Match the naming
